/**
 * ABNState encapsulates the information pertaining to a state in a boolean
 * network
 *
...
public class ABNState {
	 ...
	 *            An array of genes
	 * @param time
	 *            An int representing time stamp of when state was created
	 * @param stateID
	 *            An int for identifying this state;
	 */
	 ...
	 *            An array of genes
	 * @param time
	 *            An int representing time stamp of when was state created
	 * @param stateID
	 *            An int for identifying this state;
	 */
	 ...
	 * 
	 * @param geneName
	 *            String of gene name whose update function should be applied
	 * @return successor A ABNState created by the application of the update
	 *         function
	 */
	 ...
	 * 
	 * @return result String containing the state id and time created and
	 *         whether each gene is expressed
	 */
	...
	public String toString2() {
		...
		int boolAsInt = 0;
		for (Gene gene : geneArray) {
			boolAsInt = stateOfGenes[i] ? 1 : 0;
			result += String.format("%-9s ", boolAsInt);
			i++;
		}
		return result;
	}
	 ...
	 * 
	 * @param s
	 *            String of the gene name to be found
