...
public class AndNode extends ExpressionNode{
	...
	/** Calls the evaluate method of its children 
	 * and performs an 'AND' operation on them
	 *
	 * @return boolean  Returns true when both child nodes evaluate to true
	 *  false otherwise	
	 */	
	@Override
